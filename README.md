...
1. Download **`TotalRecall-1.1.0-Portable-win-x64.zip`** from <https://github.com/ilyafainberg/TotalRecall/releases>.
...
```
TotalRecall-1.1.0-Portable-win-x64\
├─ TotalRecall\
...
1. Download **`TotalRecall-Mcp-1.1.0-win-x64.zip`** from the release page.
...
1. Download **`TotalRecall-Mcp-1.1.0-win-x64.zip`** from <https://github.com/ilyafainberg/TotalRecall/releases/latest>.
